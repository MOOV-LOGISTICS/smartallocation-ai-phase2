...
export const I18N = {
  en: {
    ...
    stats: { total: 'Total POs', not_started: 'Not Started', assigned: 'AI Auto Assigned', overridden: 'Overridden', on_hold: 'On Hold', exception: 'Exception', trend: { total: 'All imported', not_started: '+4 in last hour', assigned: 'Avg 1.8s per PO', overridden: '{rate}% override rate', on_hold: 'Need supplier action', exception: 'Need human review' } },
  ...
  zh: {
    ...
    stats: { total: 'PO 总数', not_started: '未启动', assigned: 'AI 自动预排', overridden: '手动覆盖', on_hold: '已暂缓', exception: '异常', trend: { total: '已全部导入', not_started: '过去 1 小时 +4', assigned: '平均 1.8 秒/PO', overridden: '覆盖率 {rate}%', on_hold: '需供应商响应', exception: '需人工介入' } },
